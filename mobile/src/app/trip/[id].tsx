...
export default function Trip() {
    ...
    async function handleUpdateTrip() {
        try {
            ...
            if (!destination || !selectedDates.startsAt || !selectedDates.endsAt) {
                return Alert.alert
                    ("Atualizar viagem", "Lembre-se de além de preencher o destino, selecione a data de início e de fim da vaigem")
            }
    ...
    return (
        <View className="flex-1 px-5 pt-16 bg">
            ...
            <View className="w-full absolute -bottom-1 self-center justify-end pb-5 z-10 bg-zinc-950">
                <View className="w-full bg-zinc-900 p-4 rounded-lg border-zinc-800 gap-2">
                    <Button onPress={() => setOption("activity")}
                    ...
                    <Button className="" onPress={() => setOption("details")}
            ...
            >
                ...
                <View className="gap-2 my-4">
                    ...
                    <Button
                        className="mt-3"
                        onPress={handleUpdateTrip} isLoading={isUpdatingTrip}
                    >
            ...
            >
                <View className="gap-4 mt-4">
                    <Text className="text-zinc-400 font-regular leading-6 my-2">
                        ...
                        <Text className="font-semibold text-zinc-100">
                            {" "}
                            {dayjs(tripDetails.starts_at).date()} á
                            {" "}

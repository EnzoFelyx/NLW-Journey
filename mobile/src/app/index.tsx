...
export default function Index() {
    ...
    function handleAddEmail() {
        ...
        if (emailAlreadyExists) {
            return Alert.alert("Convidado", "Este e-mail já foi convidado!")
        }
    ...
    return (
        <View className="flex-1 items-center justify-center px-5">
            ...
            <TouchableOpacity>
                <Text className="text-zinc-300 underline">termos de uso e
                    de privacidade.</Text>
            </TouchableOpacity>
                ...
                <View className="my-2 flex-wrap gap-2 border-b border-zinc-800 py-5 items-start">
                    {
                        emailsToInvite.length > 0 ? (
                            ...
                            <Text className="text-zinc-500 text-base font-regular">Nenhum e-mail adicionado</Text>
                        )
                    }
                </View>
